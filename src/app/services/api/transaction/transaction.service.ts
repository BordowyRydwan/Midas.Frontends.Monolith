...
export const TRANSACTIONS_API_URL = new InjectionToken<string>('TRANSACTIONS_API_URL');
...
export class TransactionApiService extends BaseApiService implements ITransactionApiService {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(TRANSACTIONS_API_URL) baseUrl?: string) {
        super();
        this.http = http;
